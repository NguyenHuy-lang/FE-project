...
function forgotPassword() {
    ...
    .then(response => {
        ...
        // If the request was successful, prompt the user for the OTP code
        return response.json();
    })
    .then(data => {
        // Display a form for the user to enter the OTP code
        var otpForm = document.createElement('form');
        otpForm.setAttribute('method', 'POST');
        otpForm.setAttribute('action', 'reset-password');
        
        var otpLabel = document.createElement('label');
        otpLabel.setAttribute('for', 'otp');
        otpLabel.textContent = 'Enter the OTP code you received by email:';
        ...
        var otpSubmit = document.createElement('input');
        otpSubmit.setAttribute('type', 'submit');
        otpSubmit.setAttribute('value', 'Submit');
        
        otpForm.appendChild(otpLabel);
        otpForm.appendChild(otpInput);
        otpForm.appendChild(otpSubmit);
